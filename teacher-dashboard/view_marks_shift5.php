    ...
    <main role="main" class="col-md-10 ml-sm-auto px-4">
      <div class="dash-output-section">
        ...
        <ul class="nav sub-nav">
          ...
          <li class="nav-item">
            <a href="view_marks_shift5.php?course=<?php echo $cour;?>" class="nav-link active">
        ...
        <div class="info-display">
          ...
          <div class="table-responsive mt-4">
              ...
              <th>Edit</th>
               ...
               <?php
                $select = "Select student.student_Fname,student.student_Lname,
                        ...
                        AND courses.course_ID = '$cour' AND student.status = 'On' AND student.student_Shift = 'Weekend' 
            ...
            if($page>1){
              ...
              class="page-link" 
              href="view_marks_shift5.php?course='. $cour .'&page='. ($page-1) .'" style="background: #1ca48c; color: #f2f2f2;"> <i class="fas fa-caret-left"></i> Prev</a></li>';
            }             
            //display the links to the pages
            for($i=1; $i<=$nber_of_Pages; $i+=1){
                echo '<li class="page-item"><a
                class="page-link" 
                href="view_marks_shift5.php?course='. $cour .'&page='. $i .'"> '. $i .' </a></li>';
            }
            if($i-1>$page){
            echo '<li class="page-item"><a
            class="page-link" 
            href="view_marks_shift5.php?course='. $cour .'&page='. ($page+1) .'" style="background: #1ca48c; color: #f2f2f2;"> Next <i class="fas fa-caret-right"></i></a></li>';
            }
            ?>
            </ul> 
        </div>      
