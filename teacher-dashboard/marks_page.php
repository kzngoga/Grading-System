...
<html lang="en">
<head>
<title><?php echo $fname;?> | My Courses</title>
  ...
  <div class="row">
    ...
    <main role="main" class="col-md-10 ml-sm-auto px-4">
      <div class="dash-output-section">
        <h2>Students' Marks Information</h2>
        <?php 
            $select = "Select * From courses where dep_ID = '$departID' 
            GROUP BY course_ID";
        ...
        <div class="row mt-4">
            ...
            <div class="course-section">
                <h3><?php echo $row["course_Name"];?> Course</h3>
                <div class="row">
                <div class="col-md-6">
                    <a href="student_add_marks1.php?course=<?php echo $row["course_ID"];?>" 
                    class="btn btn-primary"><i class="fas fa-file-alt"></i> 
                    Add Marks</a>
                </div>                  
                <div class="col-md-6">
                    <a href="view_marks_shift1.php?course=<?php echo $row["course_ID"];?>" class="btn btn-primary"><i class="fas fa-eye"></i> 
                    View Marks</a>
                </div>
                </div>
            </div>
            ...
            <?php } 
              ...
              <div class="course-section" style="border-left: 5px solid #5d6a7d;">
                  ...
                  <div class="col-md-6">
                      <a href="student_add_marks1.php?course=<?php echo $row["course_ID"];?>" 
                      class="btn btn-dark"><i class="fas fa-file-alt"></i> 
                      Add Marks</a>
                  </div>                  
                  <div class="col-md-6">
                      <a href="view_marks_shift1.php?course=<?php echo $row["course_ID"];?>" class="btn btn-dark"><i class="fas fa-eye"></i> 
                      View Marks</a>
                  </div>
                  </div>
              </div>
