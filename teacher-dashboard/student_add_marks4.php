  ...
  <div class="row">
    ...
    <main role="main" class="col-md-10 ml-sm-auto px-4">
      <div class="dash-output-section">
        <h2>Add Students Marks (<?php echo $cname;?>)</h2>
        <ul class="nav sub-nav">
           <li class="nav-item">
            <p class="nav-link sub-nav-head"><i class="fas fa-info-circle"></i> Class Info.</p>
          </li>     
          <li class="nav-item">
            <a href="student_add_marks1.php?course=<?php echo $cour;?>" class="nav-link">
              <i class="fas fa-sun sub-icon"></i> 8h - 10h
            </a>
          </li>               
          <li class="nav-item">
            <a href="student_add_marks2.php?course=<?php echo $cour;?>" class="nav-link">
              <i class="fas fa-sun sub-icon"></i> 11h - 13h
            </a>
          </li>           
          <li class="nav-item">
            <a href="student_add_marks3.php?course=<?php echo $cour;?>" class="nav-link">
              <i class="fas fa-cloud-sun sub-icon"></i> 15h - 17h
            </a>
          </li>           
          <li class="nav-item">
            <a href="student_add_marks4.php?course=<?php echo $cour;?>" class="nav-link active">
              <i class="fas fa-cloud-moon sub-icon"></i> 18h - 20h
            </a>
          </li>          
          <li class="nav-item">
            <a href="student_add_marks5.php?course=<?php echo $cour;?>" class="nav-link">
        ...
        <div class="info-display">
          ...
          <input type="text" name="sBox" id="sBox" placeholder="Search Student" class="form-control">
          ...
          <div class="table-responsive">
              ...
              <th>Add Marks</th>
               ...
               <?php
                $select = "Select student.student_Fname,student.student_Lname,
                        ...
                        WHERE department.dep_ID = '$departID'  AND student.status = 'On' AND student.student_Shift = '18h-20h' ORDER BY student.student_Lname";
                $run_select = mysqli_query($con, $select);
                ...
                <td><a href="add_marks.php?student=<?php echo $stdId;?>&course=<?php echo $cour;?>" 
            ...
            if($page>1){
              ...
              class="page-link" 
              href="student_add_marks4.php?course='. $cour .'&page='. ($page-1) .'" style="background: #1ca48c; color: #f2f2f2;"> <i class="fas fa-caret-left"></i> Prev</a></li>';
            }             
            //display the links to the pages
            for($i=1; $i<=$nber_of_Pages; $i+=1){
                echo '<li class="page-item"><a
                class="page-link" 
                href="student_add_marks4.php?course='. $cour .'&page='. $i .'"> '. $i .' </a></li>';
            }
            if($i-1>$page){
            echo '<li class="page-item"><a
            class="page-link" 
            href="student_add_marks4.php?course='. $cour .'&page='. ($page+1) .'" style="background: #1ca48c; color: #f2f2f2;"> Next <i class="fas fa-caret-right"></i></a></li>';
            }
            ?>
            </ul>    
        </div>      
