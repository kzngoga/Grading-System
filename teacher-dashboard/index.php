  ...
  <div class="row">
    ...
    <main role="main" class="col-md-10 ml-sm-auto px-4">
      <div class="dash-output-section">
        ...
        <a class="btn btn-primary back-btn mt-3" 
        href="updates/edit_profile_teacher.php">
            ...
            <div class="modal-content">
              ...
              <?php
                ...
                if(isset($_POST['checkPwd'])){
                  ...
                  $pass = MD5($password);
                  $select_old_pwd = "Select * from teacher WHERE password = '$pass' 
                  AND teacher_ID = '$tchrId'";
              ...
              <div class="modal-body">
                ...
                <form action="index.php" method="post">
                  ...
                  <div class="form-group">
                    <button class="btn btn-outline-light form-control" style="" type="submit" name="checkPwd" id="checkPwd"class="form-control"><span>Check </span></button>
                 </div>
                 <span id="error"> 
                   <?php echo "" . " " . $msg;?></span>
                </form>
