    ...
    <main role="main" class="col-md-10 ml-sm-auto px-4">
      <div class="dash-output-section">
        ...
        <ul class="nav sub-nav">
          ...
          <li class="nav-item">
            <a href="view_students_shift3.php" class="nav-link active">
        ...
        <div class="info-display">
          ...
          <div class="table-responsive mt-4">
            ...
            if($page>1){
              ...
              class="page-link" 
              href="view_students_shift3.php?page='. ($page-1) .'" style="background: #1ca48c; color: #f2f2f2;"> <i class="fas fa-caret-left"></i> Prev</a></li>';
          }            
            //display the links to the pages
            for($i=1; $i<=$nber_of_Pages; $i++){
                echo '<li class="page-item"><a
                class="page-link" 
                href="view_students_shift3.php?page='. $i .'"> '. $i .' </a></li>';
            }
            if($i-1>$page){
            echo '<li class="page-item"><a
            class="page-link" 
            href="view_students_shift3.php?page='. ($page+1) .'" style="background: #1ca48c; color: #f2f2f2;"> Next <i class="fas fa-caret-right"></i></a></li>';
            }
            ?>
            </ul>     
        </div>      
