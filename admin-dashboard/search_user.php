  ...
  <div class="row">
    <nav class="col-md-2 d-none d-md-block sidebar">
      ...
      <div class="dash-output-section">
        ...
        href="view_users.php"><span>Back To Full List</span></a>        
            ...
            <th>Remove</th>
             ...
             <?php
                if(isset($_POST['search'])){
                  ...
                  user_Fname LIKE '%$searchBox%' 
                  OR user_Lname LIKE '%$searchBox%' ORDER BY users.user_Lname";
                  ...
                  if($number_of_results > 0){
                    while($row_select = mysqli_fetch_assoc($result)){
                      ...
                      echo "<tr>
                            ...
                            <td>$role</td>
                            <td>$status</td>
                            <td><a href='updates/update_user.php?editUser=$userId'><button type='button' class='btn btn-success' 
                            title='Update'><span class='fa fa-pen'></span></button></a></td>
                            <td>
                            <button type='button' class='btn btn-danger' 
                            title='Remove' data-toggle='modal' data-target='#remove$userId'><span class='fa fa-trash'></span></button></td>
                      </tr>";
                      ?>
