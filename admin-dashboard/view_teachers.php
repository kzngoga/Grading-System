...
<html lang="en">
<head>
<title><?php echo $fname;?> | View Teachers</title>
...
<nav class="navbar navbar-expand-md bg-dark navbar-dark fixed-top main-nav">
  <div class="container">
      ...
      <li class="nav-item">
        ...
        <i class="fas fa-chalkboard-teacher"></i> Logout</a>
      </li>
      </ul>
    </div>
</nav>
  ...
  <div class="row">
    ...
    <main role="main" class="col-md-10 ml-sm-auto px-3">
      <div class="dash-output-section">
        ...
        <form action="search_teacher.php" method = "POST" class="form-inline justify-content-end">
        <input type="text" name="sBox" id="sBox" placeholder="Search Teachers" class="form-control">
        ...
        <div class="table-responsive">
          <table class="table table-striped">
           <thead>
            ...
            <th>Remove</th>
             ...
             <?php
              $select = "Select teacher.teacher_ID,teacher.teacher_Fname,teacher.teacher_Lname,
              ...
              <td><?php echo $depName; ?></td>
                ...
                // echo $verdict;
                ?></td>
              <td><a href="updates/update_teacher.php?editTchr=<?php echo $tchrID;?>"><button type="button" class="btn btn-success" 
              title="Update"><span class="fa fa-pen"></span></button></a></td>
              <td><?php
                  if($status==="On"){
              echo "<button type='button' class='btn btn-danger'
              title='Remove' data-toggle='modal' data-target='#remove$tchrID'><span class='fa fa-trash'></span></button>";
                  }                  
                  else{
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      <a href="removed/remove_teacher.php?removeTchr=<?php echo $tchrID;?>" 
          ...
          if($page>1){
              ...
              class="page-link" 
              href="view_teachers.php?page='. ($page-1) .'" style="background: #1ca48c; color: #f2f2f2;"> <i class="fas fa-caret-left"></i> Prev</a></li>';
          }

          for($i=1; $i<=$nber_of_Pages; $i++){
              echo '<li class="page-item"><a
              class="page-link" 
              href="view_teachers.php?page='. $i .'"> '. $i .' </a></li>';
          }
          if($i-1>$page){
          echo '<li class="page-item"><a
          class="page-link" 
          href="view_teachers.php?page='. ($page+1) .'" style="background: #1ca48c; color: #f2f2f2;"> Next <i class="fas fa-caret-right"></i></a></li>';
          }
          ?>
          </ul>
      </div>
