...
<html lang="en">
<head>
<title><?php echo $fname;?> | Add Teachers</title>
  ...
  <div class="row">
    <nav class="col-md-2 d-none d-md-block sidebar">
      <div class="sidebar-sticky">
        ...
        <ul class="nav flex-column dash-nav">
          ...
          <li class="nav-item">
          <a href="add_teachers.php" class="nav-link active">
    ...
    <main role="main" class="col-md-10 ml-sm-auto px-4">
      <div class="dash-output-section">
        <h2>Add Teacher</h2>
        <form method="post" action="add_teachers.php" id="myForm" novalidate>
          <div class="form-row">
        ...
        <div class="form-group">
            <button class="form-control btn btn-primary" id="addBtn" type="submit" name="addBtn"> <span>Add Teacher</span></button>
...
<script src="../js/script_add_teacher.js"></script>
...
(teacher_Fname,teacher_Lname,teacher_Mail,teacher_Gen,teacher_Address,teacher_Phone,password,dep_ID,status) 
VALUES ('$fname','$lname','$email','$gender','$address','$phone', '$pass', 
'$department','On')";
...
ON teacher.dep_ID = department.dep_ID WHERE department.dep_ID = '$department'";
...
if($run_insert){
  ...
  Swal.fire({
    ...
    html:
    '<h1 class=alert-title>Success</h1>' + '<p class=alert-text>A new teacher was added successfully!</p>, ' + '<a href=view_teachers.php class= alert-btn>Continue!</a>',
    type: 'success',
    animation: true,
    customClass: {
    ...
    echo "<script>
    alert('Teacher Wasn't Added')</script>";
}
}
?>
</body>
