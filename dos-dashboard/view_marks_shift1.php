...
<html lang="en">
<head>
<title><?php echo $fname;?> | Marks For <?php echo $stdFname;?></title>
  ...
  <div class="row">
    ...
    <main role="main" class="col-md-10 ml-sm-auto px-4">
      <div class="dash-output-section">
        <h2>All Marks For <?php echo $stdLname . " " .$stdFname?></h2>
        <a class="btn btn-primary back-btn mt-3" 
        href="department_info_shift1.php?class=<?php echo $departID;?>"><span>Back To Students List</span></a>   
