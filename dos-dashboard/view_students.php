  ...
  <div class="row">
    ...
    <main role="main" class="col-md-10 ml-sm-auto px-3">
      <div class="dash-output-section">
        ...
        <form action="search_students.php" method="POST" class="form-inline justify-content-end">
        ...
        <div class="table-responsive">
            ...
            <th>Report</th>
             ...
             <?php
              $select = "Select student.student_ID,student.student_Fname,student.student_Lname,
                        ...
                        ON student.dep_ID = department.dep_ID ORDER BY student.student_ID";
              ...
              <td>
                ...
                // echo $verdict;
                ?></td>
              <td><a href="student_transcript.php?report=<?php echo $stdId;?>" 
                target="_blank">
              <button type="button" style="width: 90% !important;" class="btn btn-primary" 
              title="Transcript"> <i 
              class="fa fa-file-alt"></i></button></a></td>
              </tr>
              <?php }?>
                <?php
          ...
          if($page>1){
              ...
              class="page-link" 
              href="view_students.php?page='. ($page-1) .'" style="background: #1ca48c; color: #f2f2f2;"> <i class="fas fa-caret-left"></i> Prev</a></li>';
          }

          for($i=1; $i<=$nber_of_Pages; $i++){
              echo '<li class="page-item"><a
              class="page-link" 
              href="view_students.php?page='. $i .'"> '. $i .' </a></li>';
          }

          if($i-1>$page){
          echo '<li class="page-item"><a
          class="page-link" 
          href="view_students.php?page='. ($page+1) .'" style="background: #1ca48c; color: #f2f2f2;"> Next <i class="fas fa-caret-right"></i></a></li>';
          }          
          ?>
          </ul>
      </div>
