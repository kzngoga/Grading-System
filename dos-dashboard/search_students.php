  ...
  <div class="row">
    <nav class="col-md-2 d-none d-md-block sidebar">
      ...
      <div class="dash-output-section">
        ...
        href="view_students.php"><span>Back To Full List</span></a>        
            ...
            <th>Report</th>
             ...
             <?php
                if(isset($_POST['search'])){
                  ...
                  $sql = "Select student.student_ID,student.student_Fname,student.student_Lname,
                        ...
                        ON student.dep_ID = department.dep_ID WHERE 
                  student_Fname LIKE '%$searchBox%' 
                  OR student_Lname LIKE '%$searchBox%' ORDER BY student.student_Lname";
                  ...
                  if($number_of_results > 0){
                    while($row_select = mysqli_fetch_assoc($result)){
                     ...
                     $num++;                     
                      ...
                      <td>$shift</td>
                      <td>$status</td>
                      <td><a href='student_transcript.php?report=$stdId' 
                      target='_blank'><button type='button' 
                      class='btn btn-success' title='Transcript' 
                      style='width: 90% !important;'>
                      <span class='fa fa-file-alt'></span></button></a></td>
                      </tr>";
                     }
                   }
                  else{
