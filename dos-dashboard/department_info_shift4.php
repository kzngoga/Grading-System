...
<html lang="en">
<head>
<title><?php echo $departName;?> | Department Students(18h-20h)</title>
        ...
        <div class="info-display">
          ...
          <div class="table-responsive mt-4">
            <table class="table table-striped">
             <thead>
               ...
               <?php
                ...
                <td><a href="view_marks_shift4.php?marksFor=<?php echo $stdId;?>">
            ...
            if($page>1){
              ...
              class="page-link" 
              href="department_info_shift4.php?class='.$departId.'&page='. ($page-1) .'" style="background: #1ca48c; color: #f2f2f2;"> <i class="fas fa-caret-left"></i> Prev</a></li>';
            }            
            //display the links to the pages
            for($i=1; $i<=$nber_of_Pages; $i++){
                echo '<li class="page-item"><a
                class="page-link" 
                href="department_info_shift4.php?class='.$departId.'&page='. $i .'"> 
                '. $i .' </a></li>';
            }
            ...
            echo '<li class="page-item"><a
            class="page-link" 
            href="department_info_shift4.php?class='.$departId.'&page='. ($page+1) .'" style="background: #1ca48c; color: #f2f2f2;"> Next <i class="fas fa-caret-right"></i></a></li>';
            }            
            ?>
            </ul>    
        </div>      
